...
Feature: Streaming Parser for Large Files
  ...
  @streaming @memory @AC-XK-STREAM-001 @SCN-XK-STREAM-001
  ...
  @streaming @fallback @AC-XK-STREAM-002 @SCN-XK-STREAM-002
  ...
  @streaming @context @AC-XK-STREAM-003 @SCN-XK-STREAM-003
  ...
  @streaming @handler @AC-XK-STREAM-004 @SCN-XK-STREAM-004
